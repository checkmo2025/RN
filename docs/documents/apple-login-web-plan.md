...
![Apple 웹 인증 도메인과 Return URL 확인 화면](./assets/apple-login/apple-web-auth-configuration.png)
...
- [약관 백엔드 계획](./terms-agreement-backend-plan.md)
- [약관 웹 계획](./terms-agreement-fe-plan.md)
