...
| ⬜ | **공지 제목 초과 토스트** | 모임 > 모임 상세 > 공지 작성/수정 > 제목 입력칸 | BE/RN 40자 일치로 수정 완료. RN 입력칸 내부 스크롤/하단 여백 보정 유지. iOS·Android에서 제목 초과 토스트, 내부 스크롤, 카운터 가시성 확인 필요. | 2026-06-17 | 2026-06-27 |
| ⬜ | **공지 내용 초과 토스트** | 모임 > 모임 상세 > 공지 작성/수정 > 내용 입력칸 | BE/RN 1000자 일치로 수정 완료. RN 입력칸 내부 스크롤/하단 여백 보정 유지. iOS·Android에서 내용 초과 토스트, 부모 스크롤 충돌 여부, 마지막 줄/커서 가시성 확인 필요. | 2026-06-17 | 2026-06-27 |
