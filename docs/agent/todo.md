...
| ⬜ | **공지 제목 입력 제한/토스트** | 모임 → 관리 → 공지 작성 | 50자 초과 입력/붙여넣기 시 토스트 노출 + 추가 입력 차단. 제목 카운터가 입력칸 위 라벨 우측에 표시되고, 제목이 길어지면 자동 높이 확장/초기화되는지 재확인. | 2026-06-14 | 2026-06-14 |
| ⬜ | **공지 내용 글자수 카운터** | 모임 → 관리 → 공지 작성 | 내용 카운터가 입력칸 위 라벨 우측에 표시되고 `현재/2000`이 실시간 갱신되는지, 2000자 제한/토스트/내부 스크롤 및 커서 이탈 없음 여부 재확인. | 2026-06-14 | 2026-06-14 |
...
| ⬜ | **운영진 관리 바텀시트 제스처** | 모임 → 운영진 관리 메뉴 | 메뉴가 스크롤되고, 위로 끌면 확장 / 아래로 당기면 깜빡임 없이 자연스럽게 아래로 사라지는지 재확인. | 2026-06-14 | 2026-06-14 |
